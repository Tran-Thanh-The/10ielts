...
export class InvoiceCreateFlowWhenPaymentCreate1731091381585 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "invoice_product" ("courseId" uuid, "practiceId" uuid, "invoiceId" uuid NOT NULL, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d79d227662ea59bababb37f2553" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "invoice_product" ADD CONSTRAINT "FK_b5379e222862521cc1305038f96" FOREIGN KEY ("practiceId") REFERENCES "practice_exercise"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "invoice_product" ADD CONSTRAINT "FK_cc3204afb98ea70a5b4826b9395" FOREIGN KEY ("courseId") REFERENCES "course"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "invoice_product" DROP CONSTRAINT "FK_cc3204afb98ea70a5b4826b9395"`);
        await queryRunner.query(`ALTER TABLE "invoice_product" DROP CONSTRAINT "FK_28451c43926a7b7e82b80b2d3ca"`);
        await queryRunner.query(`ALTER TABLE "invoice_product" DROP CONSTRAINT "FK_b5379e222862521cc1305038f96"`);
        await queryRunner.query(`ALTER TABLE "invoice" DROP CONSTRAINT "FK_f8e849201da83b87f78c7497dde"`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_da5996fb3139d3fe0256879cad" ON "invoice" ("orderCode") `);
    }
