...
export class UpdateAnswerHistory1734354339296 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "question" ALTER COLUMN "fileType" DROP NOT NULL`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "question" ALTER COLUMN "fileType" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "answer_history" DROP COLUMN "answers"`,
    );
  }
}
